package com.blogspot.prajbtc.coronareport;
...
import com.blogspot.prajbtc.coronareport.models.TotalOutbreak;
import com.blogspot.prajbtc.coronareport.utils.Constants;
        ...
        protected Response doInBackground(Void... voids) {
            ...
            try {
                ...
                for (int i = 1; i < rows.size(); i++) { //first row is the col names so skip it.
                    ...
                    country.setCountryName(cols.get(1).text());
                    ...
                    country.setActiveCases(cols.get(7).text());
                    country.setSeriousCritical(cols.get(8).text());
                    country.setTotalTested(cols.get(11).text());
